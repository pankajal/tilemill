...
- (NSComparisonResult)aCompareVersion:(NSString *)versionA toVersion:(NSString *)versionB;
{
...
- (NSComparisonResult)compareVersion:(NSString *)versionA toVersion:(NSString *)versionB {
    NSRange range = [versionA rangeOfString:@"."];
    if (range.location == NSNotFound && [versionA length] >= 4) {
        return NSOrderedAscending;
    }
    return [self aCompareVersion:versionA toVersion:versionB];
}
